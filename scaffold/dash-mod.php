			 ...
			 function listHandler(e, createItem, createItemArgs, validate,  validateArgs){
	 			 if (this.classList.contains('el-list-shell')){
					 if(e.target.classList.contains('remove-icon')){
					 	e.target.closest('ul.thelist').removeChild(e.target.closest('li'));//originally : parentNode. & parentNode.parentNode.
				 	 }
	 		 ...
	 		 function shareesHandler(e ){
 	  		...
 	  		function manageListHandler(e){
	 	  		...
	 	  		let listSegment = e.target.closest('.section');//originally: parentNode.parentNode.parentNode;
