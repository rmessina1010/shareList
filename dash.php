	...
	<body>
		...
		<? include ('includes/top_nav.php'); ?>
  			<form  id="listCTR" method="POST">
				...
				<div class="row no-gutters">
							<div class="col  p-2"><label class="form-control"><input  type="checkbox" name="all" id="all"   value="1"  <? echo  (isset($_SESSION["LISTlogged"]['prefs']['view']) && $_SESSION["LISTlogged"]['prefs']['view']) ? ' CHECKED ' : '' ; ?>	> View All</label></div>
							<div class="col  p-2"><label class="form-control"><input  type="checkbox" name="accordion" id="accordion"   value="1" <? echo  (isset($_SESSION["LISTlogged"]['prefs']['acc']) && $_SESSION["LISTlogged"]['prefs']['acc']) ? ' CHECKED ' : '' ; ?>					 
 > Accordion</label></div>
							<div class="col-md p-2"><label class="form-control"><input   type="checkbox" name="auto" id="auto" value="1" <? echo  (isset($_SESSION["LISTlogged"]['prefs']['auto']) && $_SESSION["LISTlogged"]['prefs']['auto']) ? ' CHECKED ' : '' ; ?>					 
